  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'relative z-50 max-h-96 min-w-[8rem] max-w-[400px] overflow-hidden rounded-md border border-border bg-popover shadow-md shadow-black/5 text-secondary-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
          position === 'popper' &&
...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        'relative flex w-full cursor-default select-none items-center rounded-none px-2 py-1.5 text-[13px] outline-hidden text-foreground hover:bg-primary/10 focus:bg-primary/10 data-disabled:pointer-events-none data-disabled:opacity-50 transition-colors',
        indicatorPosition === 'left' ? 'ps-8' : 'pe-8',
        className,
      )}
      {...props}
    >
