...
function StepperIndicator({
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "relative flex items-center overflow-hidden justify-center size-7 shrink-0 border-background bg-accent text-accent-foreground rounded-full text-xs data-[state=completed]:bg-[#20BD44] data-[state=completed]:text-primary-foreground data-[state=active]:bg-white data-[state=active]:text-black",
        className
      )}
    >
